        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><router-link tag="a" to="/activityinquiry"><i class="ti-more"></i>活动创建与查询</router-link></li>
              <li><router-link tag="a" to="/activityapproval"><i class="ti-more"></i>活动审批与权限分配</router-link></li>
              <li class="treeview">
                <a href="#">活动章管理
                  <span class="pull-right-container">
                    <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                  <li><a href="card_advanced.html"><i class="ti-more"></i>活动章查询</a></li>
                </ul>
              </li>
            </ul>
          </li>
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="chat.html"><i class="ti-more"></i>发布预警</a></li>
          ...
          <li class="treeview">
            <a href="#">
              <i data-feather="mail"></i> <span>帐号管理</span>
              <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
            </a>
